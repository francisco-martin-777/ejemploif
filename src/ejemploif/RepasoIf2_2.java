...
public class RepasoIf2_2 {
    ...
    public static void main(String[] args) {
        ...
        int notaExamen;
        String practicasEntregadasSiNo;
        double ingresos;
        boolean haEntregadoPracticas;
        ...
        System.out.println("cuanto dinero ganas");
        ingresos = Double.parseDouble(miScanner.nextLine());

        if (notaExamen >= 0 && notaExamen <= 10) {

            System.out.println("has hecho las practicaa?(si/no)");
            practicasEntregadasSiNo = miScanner.nextLine();

            if (practicasEntregadasSiNo.equals("si")) {
                haEntregadoPracticas=true;
            } else {
                haEntregadoPracticas=false;
            }
            
            
            if (notaExamen >= 5 && haEntregadoPracticas==true) {
               estaAprobado=true;
                System.out.println("estas aprobado");
            } else if (notaExamen == 4 && haEntregadoPracticas==true) {
           ...
           // Este es independiente para mirar la beca
            if (estaAprobado==true && ingresos < 1000) {
